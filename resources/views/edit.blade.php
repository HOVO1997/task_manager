        ...
        <div class="content task_content">
            ...
            <form action="{{ route('update',$product->id) }}" method="POST" >
                ...
                <div>
                    ...
                    <input type="text" placeholder="Task name" id="task_name" name="task_name" value="{{ $product->task_name }}" required>
                </div>
                <div>
                    <label style="display: block" for="for">For</label>
                    <input type="text" placeholder="User name" id="for" name="for_name" value="{{ $product->assigned_user_name }}" required>
                </div>
                <hr>
                <div>
